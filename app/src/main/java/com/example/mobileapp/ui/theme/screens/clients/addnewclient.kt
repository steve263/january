...
fun AddClient(navController: NavController){
    ...
    val painter = rememberImagePainter(data = imageuri.value ?: R.drawable.ic_android_black_24dp,
        ...
        Column (modifier = Modifier
            ...
            Row (
                ...
                Button(onClick = {
                    ...
                    imageuri.value?. let { uri -> clientRepository
                        .saveClient(uri, firstname,lastname,gender,age,bio)}
                        ?: kotlin.run { Toast.makeText(context,"please select an image",Toast.LENGTH_LONG) }
                }) {
                    Text(text = "SAVE")
                }
            }
